namespace offsets {
	...
	std::uint64_t damage_sections = 0x198;
	std::uint64_t damage_section_type = 0x128;
	std::uint64_t damage_section_life = 0x134;
	std::uint64_t damage_section_max_life = 0x138;

	uintptr_t camera_position = 0x1260;

		uintptr_t camera_rotation = 0x126C;

		uintptr_t camera_fov = 0x1278;
		uintptr_t camera_controller = 0x478;
}